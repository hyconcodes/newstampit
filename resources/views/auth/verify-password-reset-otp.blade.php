...
<body class="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-900">
    <div class="w-full max-w-md px-4 py-8">
        <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-6">
            ...
            <h1 class="text-2xl font-bold text-center text-zinc-900 dark:text-white mb-6">Reset Your Password</h1>
            ...
            <form method="POST" action="{{ route('password.reset.otp.check', $user->id) }}" class="flex flex-col items-center space-y-6">
                @csrf
                <div class="w-full">
            ...
            <form method="POST" action="{{ route('password.reset.otp.resend', $user->id) }}" class="mt-2 w-full flex flex-col items-center">
                @csrf
