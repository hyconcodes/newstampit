...
<div class="flex flex-col gap-6">
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <div class="relative">
            ...
            @if (Route::has('password.request'))
                <flux:link class="absolute end-0 top-0 text-sm text-green-600 hover:text-green-700" :href="route('password.request')" wire:navigate>
    ...
    @if (Route::has('register'))
        <div class="space-x-1 rtl:space-x-reverse text-center text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <flux:link :href="route('register')" wire:navigate class="text-green-600 hover:text-green-700">{{ __('Sign up') }}</flux:link>
        </div>
    @endif
</div>
